...
The CNTT is structured into Workstreams so it can scale and accommodate participation from the wider community. The CNTT is open to participation by any individual or organization that agrees to comply with its Term of Reference ([ToR](https://github.com/cntt-n/CNTT/blob/master/GSMA_CNTT_Terms_of_Reference.pdf)) (each such participant, a “Participant”). Each of the Workstreams within CNTT has one Lead and up to two Co-Leads. Leads and Co-Leads for each Workstream are selected by the community itself through a nomination and voting process. This document explains the CNTT policies and process regarding nomination and selection.
...
The same terms, process of nomination and selection described in [**4.2**](#4.2) must be applied to the Governance Committee leads and co-leads positions.
